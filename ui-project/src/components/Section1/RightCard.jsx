  ...
  return (
    <div className="h-full w-80 bg-amber-500 rounded-4xl overflow-hidden relative ">
      ...
      <div className="absolute top-0 h-full w-full p-8 flex justify-between flex-col">
        <h2 className="rounded-full bg-amber-50 h-10 w-10 flex justify-center items-center">1</h2>
        <div>
          ...
          <div className=" flex justify-between mt-5">
            <button className="bg-blue-500 p-2 rounded-3xl text-white">Satisfied</button>
